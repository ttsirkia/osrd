...
import { gridX, gridY } from 'applications/operationalStudies/components/Helpers/ChartHelpers';
import nextId from 'react-id-generator';
import svgDefs from 'applications/operationalStudies/components/Simulation/svgDefs';
